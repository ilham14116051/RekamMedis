            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="nm_dokter" class="col-lg-2 col-lg-offset-1 control-label">Nama Dokter</label>
                        <div class="col-lg-6">
                            <input type="text" name="nm_dokter" id="nm_dokter" class="form-control" required
                                autofocus>
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="spesialis" class="col-lg-2 col-lg-offset-1 control-label">Spesialis</label>
                        <div class="col-lg-6">
